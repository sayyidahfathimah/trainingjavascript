        ...
        <div class="container"> 
                  ...
                  <hr>
                         <form id ="recruitment">
                            ...
                            <input type="text" placeholder="Masukkan Nama" style="width:330px" id="fullname" required><br>
                            </div>

                            <div class="form">
                            <label>Email</label><a style="color: crimson;">*</a><br>
                            <input type="text" placeholder="Masukkan Email" style="width:330px" id="email" required><br>
                            </div>

                            <div>
                            <label>Phone Number</label><a style="color: crimson;">*</a><br>
                            <input type="text" placeholder="Masukkan Phone Number" style="width:330px" id="phone" required><br>
                            </div>
                ...
                <script>
                    ...
                    var lowongan = ["System Administrator", "Web Developer", "System Analyst", "ETL Developer"];
                    ...
                    result.innerHTML = 
                                        "<h3 id=text>Terima kasih telah melakukan pengisian, permintaan anda akan kami proses </h3>"+ 
